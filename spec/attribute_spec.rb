...
RSpec.describe 'Attribute parser' do
  it 'parses attributes' do
    ...
    expect(ast).to be_a(HamdownParser::Ast::Element)
  ...
  describe 'object reference' do
    ...
    it 'raises error for unmatched brackets' do
      expect { parse('%span[foo hello') }.to raise_error(HamdownParser::Error)
    end
  end
  ...
  describe 'static class' do
    ...
    context 'with invalid classes' do
      it 'raises error' do
        expect { parse('%span. hello') }.to raise_error(HamdownParser::Error)
        expect { parse('%span.{foo: "bar"} hello') }.to raise_error(HamdownParser::Error)
      end
    end
  end
  ...
  describe 'static id' do
    ...
    it 'ignores invalid static id' do
      ...
      expect(ast).to_not be_a(HamdownParser::Ast::Element)
      aggregate_failures do
